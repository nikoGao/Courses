...
AlgebraicTreeNode* newExpr1() {
  ...
  // construct data structure for expression “(8*5)"
    ...
    cout << "node" << rootLeft->getId() << ":" << rootLeft->evaluate()<<endl;
    cout << "node" << rootRight->getId() << ":" << rootRight->evaluate()<<endl;
  return root;
}
...
//   construct data structure for expression “(4*((8*5)+7))"
    ...
    cout << "node" << childLeft->getId() << ":"  << childLeft->evaluate()<<endl;
    cout << "node" << childRight->getId() << ":" << childRight->toString() << "= " << childRight->evaluate()<<endl;
    cout << "node" << secondChildLeft->getId() << ":"  << secondChildLeft->evaluate()<<endl;
    cout << "node" << secondChildRight->getId() << ":" << secondChildRight->evaluate()<<endl;
  return root;
}
...
AlgebraicTreeNode* newExpr3() {
    ...
    cout << "node" << secondLeftR->getId() << ":" << secondLeftR->evaluate()<<endl;
    cout << "node" << secondRightR->getId() << ":" << secondRightR->toString() << "= " << secondRightR->evaluate()<<endl;
    cout << "node" << thirdRLeft->getId() << ":" << thirdRLeft->evaluate()<<endl;
    cout << "node" << thirdRRight->getId() << ":" << thirdRRight->evaluate()<<endl;
    cout << "node" << thirdLLeft->getId() << ":" << thirdLLeft->evaluate()<<endl;
    cout << "node" << thirdLRight->getId() << ":"  << thirdLRight->evaluate()<<endl;
    cout << "node" << thirdLeft->getId() << ":" << thirdLeft->evaluate()<<endl;
    cout << "node" << thirdRight->getId() << ":" << thirdRight->evaluate()<<endl;
    cout << "node" << fourthLeft->getId() << ":"  << fourthLeft->evaluate()<<endl;
    cout << "node" << fourthRight->getId() << ":" << fourthRight->toString() << "= " << fourthRight->evaluate()<<endl;
    cout << "node" << fifthLeft->getId() << ":" << fifthLeft->evaluate()<<endl;
    cout << "node" << fifthRight->getId() << ":"  << fifthRight->evaluate()<<endl;
